...
func TestOverlaySim(t *testing.T) {
	t.Skip("Test is flaky, see: https://github.com/ethersphere/essentia/issues/592")
...
func watchSimEvents(net *simulations.Network, ctx context.Context, trigger chan discover.ESSNodeID) {
