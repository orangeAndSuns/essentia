...
func newTestProtocolManager(lightSync bool, blocks int, generator func(int, *core.BlockGen), peers *peerSet, odr *LesOdr, db essdb.Database) (*ProtocolManager, error) {
	var (
	...
	if lightSync {
		...
		gchain, _ := core.GenerateChain(gspec.Config, genesis, esshash.NewFaker(), db, blocks, generator)
...
// fails the test.
func newTestProtocolManagerMust(t *testing.T, lightSync bool, blocks int, generator func(int, *core.BlockGen), peers *peerSet, odr *LesOdr, db essdb.Database) *ProtocolManager {
