...
func NewLesOdr(db essdb.Database, chtIndexer, bloomTrieIndexer, bloomIndexer *core.ChainIndexer, retriever *retrieveManager) *LesOdr {
	return &LesOdr{
		db:               db,
...
func (odr *LesOdr) Database() essdb.Database {
	return odr.db
}
