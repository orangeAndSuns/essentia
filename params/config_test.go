...
func TestCheckCompatible(t *testing.T) {
	...
	tests := []test{
		{stored: AllEsshashProtocolChanges, new: AllEsshashProtocolChanges, head: 0, wantErr: nil},
		{stored: AllEsshashProtocolChanges, new: AllEsshashProtocolChanges, head: 100, wantErr: nil},
		{
		...
		{
			stored: AllEsshashProtocolChanges,
