...
func loadSnapshot(config *params.CliqueConfig, sigcache *lru.ARCCache, db essdb.Database, hash common.Hash) (*Snapshot, error) {
...
func (s *Snapshot) store(db essdb.Database) error {
