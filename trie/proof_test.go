...
// test all variations.
func makeProvers(trie *Trie) []func(key []byte) *essdb.MemDatabase {
	var provers []func(key []byte) *essdb.MemDatabase

	// Create a direct trie based Merkle prover
	provers = append(provers, func(key []byte) *essdb.MemDatabase {
		proof := essdb.NewMemDatabase()
