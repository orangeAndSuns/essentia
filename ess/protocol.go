...
var ProtocolName = "ess"

// ProtocolVersions are the upported versions of the ess protocol (first is primary).
var ProtocolVersions = []uint{ess63, ess62}
...
// ess protocol message codes
const (
	// Protocol messages belonging to ess/62
	StatusMsg          = 0x00
	...
	// Protocol messages belonging to ess/63
	GetNodeDataMsg = 0x0d
	NodeDataMsg    = 0x0e
	GetReceiptsMsg = 0x0f
	ReceiptsMsg    = 0x10
