...
import (
	...
	essentia "github.com/orangeAndSuns/essentia"
	"github.com/orangeAndSuns/essentia/accounts/abi"
...
// DeployPublicResolver deploys a new Essentia contract, binding an instance of PublicResolver to it.
...
// PublicResolver is an auto generated Go binding around an Essentia contract.
...
// PublicResolverCaller is an auto generated read-only Go binding around an Essentia contract.
type PublicResolverCaller struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// PublicResolverTransactor is an auto generated write-only Go binding around an Essentia contract.
type PublicResolverTransactor struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// PublicResolverFilterer is an auto generated log filtering Go binding around an Essentia contract events.
type PublicResolverFilterer struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// PublicResolverSession is an auto generated Go binding around an Essentia contract,
...
// PublicResolverCallerSession is an auto generated read-only Go binding around an Essentia contract,
...
// PublicResolverTransactorSession is an auto generated write-only Go binding around an Essentia contract,
...
// PublicResolverRaw is an auto generated low-level Go binding around an Essentia contract.
type PublicResolverRaw struct {
	Contract *PublicResolver // Generic contract binding to access the raw methods on
}

// PublicResolverCallerRaw is an auto generated low-level read-only Go binding around an Essentia contract.
...
// PublicResolverTransactorRaw is an auto generated low-level write-only Go binding around an Essentia contract.
...
type PublicResolverABIChangedIterator struct {
	...
	sub  essentia.Subscription // Subscription for errors, completion and termination
