...
import (
	...
	"github.com/orangeAndSuns/essentia/internal/jsre"
	"github.com/orangeAndSuns/essentia/internal/web3ext"
...
// Welcome show summary of current Gess instance and some metadata about the
// console's available modules.
func (c *Console) Welcome() {
	// Print some generic Gess metadata
	fmt.Fprintf(c.printer, "Welcome to the Gess JavaScript console!\n\n")
	c.jsre.Run(`
