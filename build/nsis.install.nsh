Name "gess ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/orangeAndSuns/essentia/issues"
!define UPDATEURL "https://github.com/orangeAndSuns/essentia/releases"
!define ABOUTURL "https://github.com/orangeAndSuns/essentia#ethereum-go"
...
# Install gess binary
Section "Gess" GESS_IDX
  SetOutPath $INSTDIR
  file {{.Gess}}

  # Create start menu launcher
  createDirectory "$SMPROGRAMS\${APPNAME}"
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\gess.exe" "--fast" "--cache=512"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\gess.exe" "attach" "" ""
  createShortCut "$SMPROGRAMS\${APPNAME}\Uninstall.lnk" "$INSTDIR\uninstall.exe" "" "" ""

  # Firewall - remove rules (if exists)
  SimpleFC::AdvRemoveRule "Gess incoming peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Gess outgoing peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Gess UDP discovery (UDP:30303)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "Gess incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\gess.exe" "" "" "Essentia" 30303 "" "" ""
  SimpleFC::AdvAddRule "Gess outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\gess.exe" "" "" "Essentia" "" 30303 "" ""
  SimpleFC::AdvAddRule "Gess UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\gess.exe" "" "" "Essentia" "" 30303 "" ""

  # Set default IPC endpoint (https://github.com/ethereum/EIPs/issues/147)
  ${EnvVarUpdate} $0 "ESSENTIA_SOCKET" "R" "HKLM" "\\.\pipe\gess.ipc"
  ${EnvVarUpdate} $0 "ESSENTIA_SOCKET" "A" "HKLM" "\\.\pipe\gess.ipc"
...
Function GetInstalledSize
  ...
  ${if} ${SectionIsSelected} ${GESS_IDX}
    SectionGetSize ${GESS_IDX} $0
