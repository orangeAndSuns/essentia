...
import (
	...
	"github.com/orangeAndSuns/essentia/accounts/usbwallet"
...
type ExternalAPI interface {
	...
	SignTransaction(ctx context.Context, args SendTxArgs, methodSelector *string) (*essapi.SignTransactionResult, error)
...
type SignerUI interface {
	...
	OnApprovedTx(tx essapi.SignTransactionResult)
...
func (api *SignerAPI) SignTransaction(ctx context.Context, args SendTxArgs, methodSelector *string) (*essapi.SignTransactionResult, error) {
	var (
		err    error
	...
	response := essapi.SignTransactionResult{Raw: rlpdata, Tx: signedTx}
