...
//
// Detailed usage document and tutorial available on the qwerty123 Wiki page:
// https://github.com/orangeAndSuns/essentia/wiki/Native-DApps:-Go-bindings-to-Essentia-contracts
package bind
