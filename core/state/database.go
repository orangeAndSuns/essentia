...
type Trie interface {
	...
	Prove(key []byte, fromLevel uint, proofDb essdb.Putter) error
}
...
func NewDatabase(db essdb.Database) Database {
...
func (m cachedTrie) Prove(key []byte, fromLevel uint, proofDb essdb.Putter) error {
