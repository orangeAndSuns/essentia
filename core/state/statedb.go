...
// StateDBs within the essentia protocol are used to store anything
...
func (self *StateDB) Copy() *StateDB {
	...
	for addr := range self.journal.dirties {
		// As documented [here](https://github.com/orangeAndSuns/essentia/pull/16485#issuecomment-380438527),
