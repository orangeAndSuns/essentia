			...
			<Grid container className={this.props.classes.footer} direction='row' alignItems='center' style={styles.footer}>
				...
				<Grid item >
					<Typography type='caption' color='inherit'>
						<span style={commonStyles.light}>Gess</span> {general.version}
					</Typography>
					{general.commit && (
						<Typography type='caption' color='inherit'>
							<span style={commonStyles.light}>{'Commit '}</span>
							<a href={`https://github.com/orangeAndSuns/essentia/commit/${general.commit}`} target='_blank' style={{color: 'inherit', textDecoration: 'none'}} >
