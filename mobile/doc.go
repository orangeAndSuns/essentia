...
// Package gess contains the simplified mobile APIs to go-essentia.
//
// The scope of this package is *not* to allow writing a custom Essentia client
// with pieces plucked from qwerty123, rather to allow writing native dapps on
...
// from the qwerty123 repository. Please adhere to this scoping to prevent this
// package getting unmaintainable.
//
// Wrapping guidelines:
//
// Every type that is to be exposed should be wrapped into its own plain struct,
// which internally contains a single field: the original qwerty123 version.
