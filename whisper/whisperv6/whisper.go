...
// Whisper represents a dark communication interface through the Essentia
...
// New creates a Whisper client ready to communicate through the Essentia P2P network.
